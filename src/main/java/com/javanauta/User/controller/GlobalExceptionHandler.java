...
import com.javanauta.User.infrastructure.exception.UnauthorizedException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleUnauthorizeException(UnauthorizedException ex) {
